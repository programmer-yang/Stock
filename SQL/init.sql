...
BEGIN
	...
	CREATE TABLE `USERS` (
	  ...
	  `U_ENABLED` VARCHAR(30) NOT NULL,
	  `U_AUTHORITY` VARCHAR(255) NOT NULL,
	  PRIMARY KEY (`U_ID`)
	...
	CREATE TABLE `STOCK` (
	  ...
	  `S_NUMBER_SUM` INT(11) NOT NULL,
	  `S_NUMBER_CUR` INT(11) NOT NULL,
	...
	INSERT INTO `USERS` (U_NAME,U_PASSWORD,U_ENABLED,U_AUTHORITY) VALUES('admin','admin','true','ROLE_ADMIN');
	INSERT INTO `USERS` (U_NAME,U_PASSWORD,U_ENABLED,U_AUTHORITY) VALUES('testuser','testuser','true','ROLE_STOCK');
	...
	INSERT INTO STOCK (S_N_ID,U_ID,S_NUMBER_SUM,S_NUMBER_CUR,S_DATA_TYPE,S_TIME) VALUES 
	((SELECT S_N_ID FROM STOCK_NAME WHERE S_N_NAME = '土豆'),(SELECT U_ID FROM USERS WHERE U_NAME = 'admin'),'0','0','1','20140921240000');
	INSERT INTO STOCK (S_N_ID,U_ID,S_NUMBER_SUM,S_NUMBER_CUR,S_DATA_TYPE,S_TIME) VALUES 
	((SELECT S_N_ID FROM STOCK_NAME WHERE S_N_NAME = '白菜'),(SELECT U_ID FROM USERS WHERE U_NAME = 'admin'),'0','0','1','20140921240000');
