...
<html lang="zh-CN">
  ...
  <body onload="os.mp.init()">
    ...
    <div class="modal fade bg-color bg-img font-color" id="add_data_page" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true" style="display: none;">
    	<!-- 内容加载区域 -->
    </div>
    ...
    <div class="container-fluid" id="content_box">
      <div class="row" >
	      ...
	      <!-- 左侧菜单  BEGIN -->
	      <div class="col-sm-3 col-md-2 sidebar"  id="content_menu">
	        	<!-- 菜单内容加载区域 -->
