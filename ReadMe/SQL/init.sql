...
BEGIN
	...
	DROP TABLE IF EXISTS STOCK_ADD_LOG;
	...
	CREATE TABLE `AUTHORITY` (
	  ...
	  PRIMARY KEY (`A_ID`),
	  KEY `U_NAME` (`U_NAME`),
	  CONSTRAINT `U_NAME` FOREIGN KEY (`U_NAME`) REFERENCES `USERS` (`U_NAME`)
	) ENGINE=INNODB AUTO_INCREMENT=100 DEFAULT CHARSET=UTF8;
	...
	CREATE TABLE `STOCK` (
	  ...
	  `S_NUMBER_SUM` VARCHAR(30) NOT NULL,
	  `S_NUMBER_CUR` VARCHAR(30) NOT NULL,
	...
	CREATE TABLE `STOCK_ADD_LOG` (
	  ...
	  `S_A_L_NUMBER` VARCHAR(30) NOT NULL,
	...
	CREATE TABLE `STOCK_LOG` (
	  ...
	  `S_ID` INT(11) NOT NULL,
	  `S_L_NUMBER` VARCHAR(30) NOT NULL,
	...
	INSERT INTO `USERS` (U_NAME,U_PASSWORD,U_ENABLED) VALUES('admin','admin','1');
	INSERT INTO `USERS` (U_NAME,U_PASSWORD,U_ENABLED) VALUES('testuser','testuser','1');
	
	INSERT INTO AUTHORITY (U_NAME,A_AUTHORITY) VALUES ('ADMIN','ROLE_ADMIN');
	INSERT INTO AUTHORITY (U_NAME,A_AUTHORITY) VALUES ('ADMIN','ROLE_STOCK');
	INSERT INTO AUTHORITY (U_NAME,A_AUTHORITY) VALUES ('TESTUSER','ROLE_STOCK');
	...
	((SELECT S_N_ID FROM STOCK_NAME WHERE S_N_NAME = '土豆'),(SELECT U_ID FROM USERS WHERE U_NAME = 'admin'),'0','0','1','20140921240000','1');
	INSERT INTO STOCK (S_N_ID,U_ID,S_NUMBER_SUM,S_NUMBER_CUR,S_DATA_TYPE,S_TIME,S_VALID) VALUES 
	((SELECT S_N_ID FROM STOCK_NAME WHERE S_N_NAME = '白菜'),(SELECT U_ID FROM USERS WHERE U_NAME = 'admin'),'0','0','1','20140921240000','1');
